...
// retorna um valor booleano que indica se o número de CPF é válido ou inválido;
function isCPF(CPF: string): boolean;
var
  dig10, dig11: string;
  s, i, r, peso: integer;
...
// retorna o CPF formatado na máscara: 999.999.999-99.
function imprimeCPF(CPF: string): string;
begin
...
// retorna o CPF formatado sem máscara.
function retiraMascaraCPF(CPF: string): string;
var
 strAux: string;
begin
